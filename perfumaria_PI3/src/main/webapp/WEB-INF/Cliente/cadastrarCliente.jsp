<%-- 
    ...
    Created on : 08/11/2018, 09:14:48
    Author     : Bruno
--%>
...
<html>
    ...
    <body>
        <nav>            
            <h2 style="color: white">Cadastro de Cliente</h2>        
                        ...
                        <div>
                            <form method="post" action="${pageContext.request.contextPath}/CadastrarCliente">
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input style="width: 300px;" required="required" type="text" name="endereco" />
                                    </div>
                                ...
                                <div class="form-group row">
                                    ...
                                    <div class="col-sm-5">
                                        <input style="width: 300px;" required="required" type="text" name="cidade" />
                                    </div>
